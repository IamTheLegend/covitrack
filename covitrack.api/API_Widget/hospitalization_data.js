...
/**
 * Provides the frontend data regarding the hospitalization of the state or county
 ...
 */
export async function hospitalization_data(reqeustParam) {
    let type;
    let idsArr = [];
    let returnArr = [];
        ...
        if (type == "states") {
            ...
            for (const id of idsArr) {
                ...
                returnArr.push({
                    ...
                    "hospital_beds_total": apiData[0].hospital_beds_total, //TotalBeds
                    "hospital_beds_occupied": apiData[0].hospital_beds_occupied, //OccupiedBeds
                    "hospital_beds_free": apiData[0].hospital_beds_free //FreeBeds
                })
            }
            idsArr = [];
            return returnArr;
